        ...
        <ScrollReveal direction="left" className="md:col-span-2">
          <div className="relative w-full max-w-sm mx-auto">
            ...
            >
              <LazyImage
                src={profileImage}
                alt="Your Name — Full Stack Engineer"
        ...
        <div className="md:col-span-3">
          <ScrollReveal direction="right">
            ...
            <h1 className="text-3xl md:text-5xl font-semibold tracking-tight leading-tight">
              I turn ideas into <span className="gradient-text">fast, elegant</span> web experiences.
            </h1>
          </ScrollReveal>
          ...
          <ScrollReveal direction="right" delay={0.15}>
            ...
            <p className="mt-4 text-text-muted text-base md:text-lg leading-relaxed">
              ...
              established teams to ship production applications across the
              full stack — from database design to pixel-perfect interfaces.
            </p>
          </ScrollReveal>
